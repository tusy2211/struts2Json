		...
		<div id="container_demo">
			...
			<div id="wrapper">
				<div id="login" class="animate form">
					<form action="process-login.html" method="post" autocomplete="on">
						<h1>Log in</h1>
						<p style="color: red;">
							<%
						...
						<p>
							<label for="username" class="uname"> Your email or
								...
								required="required" placeholder="myusername or mymail@mail.com" />
					...
					<form action="mysuperscript.php" autocomplete="on">
						...
						<p>
							<label for="usernamesignup" class="uname">Your username</label> <input
								id="usernamesignup" name="usernamesignup" required="required"
